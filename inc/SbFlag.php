<?php
class SbFlag extends SbCoreBase
{
	//--- Constructor ---//
	...
	public static function Hook(Parser $parser, $param1= NULL, $param2= 'it')
	{
		$obj = new SbFlag($parser);
	...
	private function Render($name, $mode)
	{
		...
		$title = self::$flags[$name];
			
		$text = $vText ? $title : NULL;
		$icon = $vIcon ? SbCore::ParseUri('flg:'. $name. '.png') : NULL;
		$notext = !$vText;

		return $this->RenderLink($text, NULL, $icon, NULL, $title);
	}
	...
	private static $flags = array(
		...
		'ar'=> 'Argentina', 
		'as'=> 'American Samoa', 
		'at'=> 'The Great and Powerful Republic of Austria', 
		'au'=> 'Australia', 
		'aw'=> 'Aruba', 
		'ax'=> 'Åland Islands', 
		'az'=> 'Azerbaijan', 
